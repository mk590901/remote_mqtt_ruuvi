                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  BlinkingColorIcon(
                                    //  bar_chart_sharp//                                        icon: getIcon(state.measureType??'')??Icons.hourglass_empty,
                                    icon: state.isScanning
                                        ? Icons.gps_fixed_sharp
                                        : Icons.gps_not_fixed_sharp,
                                    blinking: state.isScanning ? true : false,
                                    //getBlinking(state.state??'')/*true*/,
                                    size: 24,
                                  ),
                              ...
                              Wrap(
                                ...
                                children: [
                                  _actionButton(
                                    Icons.sync_sharp,
                                    'Sync',
                                    colorCheckSink(state),
                                    () => context.read<RemoteBleBloc>().add(
                                      Sync(),
                                    ),
                                  ),
